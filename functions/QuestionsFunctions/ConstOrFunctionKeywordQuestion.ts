...
export default async function ConstOrFunctionKeywordQuestion(
  ...
  choices.generalChocies.constOrFunctionKeyword =
    question["Function Keyword or Const to Define the Component?"];
}
